...
**Solution:** Check if the class is supported by Satori. Some classes (like `backdrop-blur`) are not supported. See the [Tailwind Support](/docs/tailwind) page for the full list.
