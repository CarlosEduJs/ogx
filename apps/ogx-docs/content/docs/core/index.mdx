...
<Cards>
  <Card title="Rendering" href="/docs/core/render" description="Convert layouts to SVG or PNG" />
  <Card title="Fonts" href="/docs/core/fonts" description="Load and manage custom fonts" />
  <Card title="Platforms" href="/docs/core/platforms" description="Target specific social platforms" />
  <Card title="ogx() Function" href="/docs/core/ogx-function" description="High-level preset-based rendering" />
  <Card title="Assets" href="/docs/core/assets" description="Handle images and external resources" />
  <Card title="Caching" href="/docs/core/cache" description="Optimize performance with caching" />
</Cards>
...
- **Need templates?** Explore [Presets](/docs/presets)
