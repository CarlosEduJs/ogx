...
// Use svg directly in dangerouslySetInnerHTML or as an img src
```

> [!TIP]
> The `/svg` module has zero Node.js dependencies, making it safe to use in any browser environment.
