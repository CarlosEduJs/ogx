...
| Preset | Description |
|--------|-------------|
| [Docs](/docs/packages/core/presets/docs) | Documentation sites with title, description, and branding |
| [Blog](/docs/packages/core/presets/blog) | Blog posts with author, date, and category |
| [Social](/docs/packages/core/presets/social) | Gradient backgrounds with handle and branding |
| [Minimal](/docs/packages/core/presets/minimal) | Clean typography on solid backgrounds |
