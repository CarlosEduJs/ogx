...
export default function ChangelogPage() {
	return (
		<main className="min-h-screen bg-fd-background text-fd-foreground pt-20">
									...
									<div className="md:sticky md:top-32 h-fit space-y-4">
										<div className="flex flex-col gap-2">
											<div className="flex items-center gap-3">
												<span className="text-4xl md:text-5xl font-black font-mono tracking-tighter text-fd-foreground group-hover:text-fd-primary transition-colors duration-500">
													v{release.version}
												</span>
												{release.isLatest && (
													<span className="px-2 py-0.5 rounded-full bg-fd-primary/20 text-fd-primary text-[10px] font-mono font-bold uppercase tracking-wider animate-pulse">
														Latest
													</span>
												)}
											</div>
									...
									<div className="relative">
										...
										<div className="space-y-12">
											...
											<div className="pt-10 border-t border-fd-border/20 flex items-center justify-between">
												<Link
													href={`https://github.com/carlosedujs/ogx/releases/tag/v${release.version}`}
													target="_blank"
